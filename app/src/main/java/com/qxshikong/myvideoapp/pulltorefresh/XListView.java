 ...
 */
package com.qxshikong.myvideoapp.pulltorefresh;
...
public class XListView extends ListView implements OnScrollListener {
	 ...
	 * @param text
	 */
	public void setmFooterTextView(String text){
	...
	protected void onScrollChanged(int l, int t, int oldl, int oldt)
	{
		...
		// 在滚动中判断是否满足自动加载条件
		//LogUtil.e("onLoadMore","check22222222222222------Load");		
	...
	{
		//LogUtil.e("onLoadMore","check------Load,"+",reachBottom="+reachBottom());		
		if (reachBottom()&& canLoad){
			startLoadMore();
		}
	}
	/**
